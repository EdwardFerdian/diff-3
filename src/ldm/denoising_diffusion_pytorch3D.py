...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        out = rearrange(out, 'b h (z x y) c -> b (h c) z x y', x = h, y = w, z = d)
        return self.to_out(out)
...
class GaussianDiffusion3D(nn.Module):
    ...
    def sample(self, batch_size = 16, return_all_timesteps = False):
        ...
        return sample_fn((batch_size, channels, image_size[0], image_size[1], image_size[2]), return_all_timesteps = return_all_timesteps)
            ...
            while self.step < self.train_num_steps:
                ...
                if accelerator.is_main_process:
                    ...
                    if self.step != 0 and self.step % self.save_and_sample_every == 0:
                        ...
                        h5util.save(f"{self.results_folder}/_result.h5", f"loss", np.asarray([total_loss]))
